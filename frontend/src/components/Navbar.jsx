...
const Navbar = ({user = {} , onLogout}) => {
  ...
  return (
    <header className='sticky top-0 z-40 bg-white/90 backdrop-blur-md shadow-sm border-b border-gray-200 font-sans'>
      <div className='flex items-center justify-between px-4 py-3 md:px-6 max-w-7xl mx-auto'>
        {/* LOGO */}
        <div className="flex items-center gap-2 cursor-pointer group"
        onClick={() => navigate('/')}>
            {/* Logo */}
            <div className="relative w-10 h-10 flex items-center justify-center rounded-xl bg-gradient-to-br from-fuchsia-500 via-purple-500 to-indigo-500 duration-300">
        ...
        <div className="flex items-center sm:gap-4">
            ...
            <div ref={menuref} className='relative'>
              <button className="flex items-center gap-2 px-3 py-2 rounded-full cursor-pointer hover:bg-purple-50 transition-colors duration-300 border border-transparent hover:border-purple-200 "
              onClick={handleMenuToggle}>
                  ...
                  <div className="text-left hidden md:block">
                      <p className="text-sm font-medium to-gray-800">{user.name}</p>
              ...
              {menuOpen && (
                <ul className="absolute top-14 right-0 w-56 bg-white rounded-2xl shadow-xl border border-purple-100 z-50 overflow-hidden animate-hadeIn">
                    ...
                    <li className="p-2">
                      <button
                        ...
                        className='w-full px-4 py-2.5 text-left hover:bg-purple-50 text-sm to-gray-700 transition-colors flex items-center gap-2 group'
                        role='menuitem'
                      >
